                ...
                <div className="flex flex-col gap-4">
                    <section>
                        ...
                        <p className="font-normal">
                            A Thing is committed to ensuring digital accessibility for people of all abilities. We aim
                            to conform to WCAG 2.1 Level AA standards.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="font-normal">
                            We regularly review and update our accessibility features. Our development process includes
