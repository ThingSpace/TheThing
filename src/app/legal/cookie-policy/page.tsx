                ...
                <div className="flex flex-col gap-6">
                    <section className="flex flex-col gap-3">
                        <p className="font-normal">
                            At A Thing, we prioritize privacy and minimize data collection. Our cookie usage is
                            intentionally limited to essential functions only.
                        </p>
                    </section>
                    ...
                    <section className="flex flex-col gap-3">
                        ...
                        <ul className="list-disc pl-6 font-normal">
                            <li>
                                Authentication token: A session cookie that keeps you logged in and expires when you
                                close your browser
                            </li>
                        </ul>
                    </section>
                    ...
                    <section className="flex flex-col gap-3">
                        ...
                        <p className="font-normal">
                            While you can control cookies through your browser settings, please note that our
                            authentication cookie is required to maintain your login session. Disabling it will prevent
                    ...
                    <section className="flex flex-col gap-3">
                        ...
                        <p className="font-normal">
                            This policy was last updated on June 18, 2025. Any changes to our cookie usage will be
                            reflected here.
                        </p>
                    </section>
                </div>
