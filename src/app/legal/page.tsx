            ...
            <div className="flex w-full max-w-4xl flex-col gap-8">
                <div className="flex flex-col gap-4 border-2 bg-white p-8 hover:border-black">
                    ...
                    <p className="text-gray-600">
                        Our commitment to transparency means all our policies are written in plain language. We believe
                        you should understand exactly how A Thing works and how your data is handled.
                    </p>
                </div>
