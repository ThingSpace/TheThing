...
export const NoteModal = () => {
    ...
    React.useEffect(() => {
        ...
        // Add all used setters to dependencies
    }, [isNotePrivate, setShowToast, setToastIntent, setToastMessage])
    ...
    }, [text, noteModelType, setToastIntent, setToastMessage, setShowToast])
