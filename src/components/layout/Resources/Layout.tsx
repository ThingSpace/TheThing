			...
			<div className="flex w-full max-w-4xl flex-col gap-8">
				<div className="flex flex-col gap-4 border-2 bg-white p-8 hover:border-black">
					...
					<p className="text-lg text-gray-700">
						If you're struggling, help is available worldwide. These resources provide support across different countries and regions. 
						In an emergency, always call your local emergency services first (911 in US/Canada, 999 in UK, 000 in Australia, 112 in EU).
					</p>
				</div>
