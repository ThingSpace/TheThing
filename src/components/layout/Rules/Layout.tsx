                ...
                <div className="flex w-fit flex-col justify-center gap-5 border-2 bg-white p-5 hover:border-black">
                    ...
                    <div className="flex flex-col font-normal">
                        <p className="prose max-w-none">
                            At <b className="font-semibold text-green-600 underline decoration-wavy">A Thing</b>, we
                            believe in the power of authentic expression. This is your space to share, reflect, and
                            connect - safely and anonymously.
                            <br />
                            <br />
                            Our community thrives on trust and mutual respect. While we encourage open dialogue and
                            diverse perspectives, we maintain strict guidelines to ensure everyone feels secure and
                            respected.
                            <br />
                            <br />
                            Breaking these rules{' '}
                            <b className="font-semibold text-red-600">will result in immediate action</b>, typically a
                            permanent ban. We take our community&apos;s safety seriously.
                            <br />
                            <br />
